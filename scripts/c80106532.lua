...
function c80106532.initial_effect(c)
	c:SetUniqueOnField(1,0,80106532)
	--Activate
	...
	e1:SetTarget(c80106532.target)
	e1:SetOperation(c80106532.activate)
	c:RegisterEffect(e1)
	--self destroy
	...
	e3:SetTarget(c80106532.drtg)
	e3:SetOperation(c80106532.drop)
	c:RegisterEffect(e3)
	--spsummon
...
function c80106532.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c80106532.activate(e,tp,eg,ep,ev,re,r,rp)
...
function c80106532.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106532,0,0x21,6,2300,500,RACE_PYRO,ATTRIBUTE_DARK) end
...
function c80106532.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106532,0,0x21,6,2300,500,RACE_PYRO,ATTRIBUTE_DARK) then
