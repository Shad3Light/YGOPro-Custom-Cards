...
function c80106542.initial_effect(c)
	c:SetUniqueOnField(1,0,80106542)
	--negate
...
function c80106542.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.DiscardHand(tp,c80106542.disfilter,1,1,REASON_COST+REASON_DISCARD)
end
...
function c80106542.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106542,0,0x21,4,1600,1400,RACE_INSECT,ATTRIBUTE_DARK) end
...
function c80106542.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106542,0,0x21,4,1600,1400,RACE_INSECT,ATTRIBUTE_DARK) then
