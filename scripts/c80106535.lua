...
function c80106535.initial_effect(c)
	c:SetUniqueOnField(1,0,80106535)
	--Activate
	...
	e1:SetTarget(c80106535.target)
	e1:SetOperation(c80106535.activate)
	c:RegisterEffect(e1)
	--self destroy
...
function c80106535.descon(e,tp,eg,ep,ev,re,r,rp)
...
function c80106535.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106535,0,0x21,4,1700,1100,RACE_ROCK,ATTRIBUTE_DARK) end
...
function c80106535.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106535,0,0x21,4,1700,1100,RACE_ROCK,ATTRIBUTE_DARK) then
