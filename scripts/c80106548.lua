...
function c80106548.initial_effect(c)
	c:SetUniqueOnField(1,0,80106548)
	--Activate
	...
	e1:SetTarget(c80106548.target)
	e1:SetOperation(c80106548.activate)
	c:RegisterEffect(e1)
	--self destroy
	...
	e3:SetCondition(c80106548.cspcon)
	e3:SetTarget(c80106548.csptg)
	c:RegisterEffect(e3)
	--spsummon
...
function c80106548.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c80106548.activate(e,tp,eg,ep,ev,re,r,rp)
...
function c80106548.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106548,0,0x21,7,2100,2100,RACE_FAIRY,ATTRIBUTE_DARK) end
...
function c80106548.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106548,0,0x21,7,2100,2100,RACE_FAIRY,ATTRIBUTE_DARK) then
