...
function c80106534.initial_effect(c)
	c:SetUniqueOnField(1,0,80106534)
	--Activate
	...
	e7:SetCondition(c80106534.tgcon)
	c:RegisterEffect(e7)
end
function c80106534.reccon(e,tp,eg,ep,ev,re,r,rp)
	if ep==tp then return false end
	local rc=eg:GetFirst()
	return rc:IsControler(tp) and rc:IsSetCard(0xca00)
end
...
function c80106534.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106534,0,0x21,11,3800,2200,RACE_FAIRY,ATTRIBUTE_DARK) end
...
function c80106534.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,80106534,0,0x21,11,3800,2200,RACE_FAIRY,ATTRIBUTE_DARK) then
